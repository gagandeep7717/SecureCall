...
public class SecureCallMain extends Activity implements OnClickListener {
    private static final String THIS_FILE = "SecureCallMain";
    ...
    public void onClick(View clickedView) {
        ...
        if(clickedId == R.id.start_btn) {
            ...
            if(TextUtils.isEmpty(error)) {
                ...
                builtProfile.display_name = "SecureCall Account";
